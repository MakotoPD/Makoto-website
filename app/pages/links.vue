<template>
	<div class="pt-24">
		...
		<div v-if="makoto?.data" class="mt-[16rem] w-full max-w-4xl mx-auto px-12 flex flex-col items-center gap-3">
				...
				<NuxtImg class="h-36 w-36 object-cover rounded-2xl border-2 border-sky-500" :src="'https://api.makoto.com.pl'+makoto.data.picture.url" alt="Makoto profile picture" />
