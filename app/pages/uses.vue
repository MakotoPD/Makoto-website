			...
			>
				<template #highlighted>
					<span class="px-2 tracking-tight italic bg-gradient-to-r from-cyan-400 to-blue-700 bg-clip-text text-transparent">
						{{ t('page.uses.header.highlightedWord') }}
					</span>
				</template>
			</i18n-t>
		</h2>
...
useSeoMeta({
  ...
  ogDescription: description,
	...
	const soft = [
		{ name: "Visual Studio Code", icon: "i-mkt-visual-studio-code"},
		{ name: "Notion", icon: "i-mkt-notion"},
		{ name: "Brave browser", icon: "i-mkt-brave"},
		{ name: "Figma", icon: "i-mkt-figma"},
		{ name: "Photoshop", icon: "i-mkt-photoshop"},
		{ name: "Illustrator", icon: "i-mkt-illustrator"},
		{ name: "Obsidian", icon: "i-mkt-obsidian-icon"},
		{ name: "Affinity", icon: "i-mkt-affinity"},
		{ name: "Discord", icon: "i-mkt-discord-icon"},
		{ name: "Slack", icon: "i-mkt-slack-icon"},
		{ name: "Asana", icon: "i-mkt-asana-icon"},
		{ name: "Thunderbird", icon: "i-mkt-thunderbird", color: 'text-blue-400'},
		{ name: "Bitwarden", icon: "i-mkt-bitwarden", color: 'text-sky-600'},
		{ name: "2FAS", icon: "i-mkt-2fas", color: 'text-red-500'},
		{ name: "Perplexity", icon: "i-mkt-perplexity-icon"},
		{ name: "Claude", icon: "i-mkt-claude-icon"},
	]
</script>