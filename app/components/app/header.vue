        ...
        <div  class="px-2 py-2 text-white rounded-3xl border border-primary-400/20 bg-black flex flex-col gap-2">
          ...
          <p class="test-xm text-neutral-600">Change lang:</p>
            <div class="flex justify-center gap-x-4">
              <a href="#" class=" bg-neutral-800/60 rounded-md border border-neutral-700/50 hover:bg-neutral-800/30 duration-200 px-1 text-neutral-500 flex gap-1" v-for="locale in availableLocales" :key="locale.code" @click.prevent.stop="setLocale(locale.code)">
